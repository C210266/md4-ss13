...
public class CustomerService implements IGenericService<Customer,Integer>{
    ...
    private final String INSERT_CUSTOMER ="INSERT INTO CUSTOMER(name,email,address,phone,sex,age) VALUES(?,?,?,?,?,?)";
    private final String UPDATE_CUSTOMER ="UPDATE CUSTOMER SET name =?,email=? ,address=?, sex =?, phone=? ,age=? WHERE id =?";
